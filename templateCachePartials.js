...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/partials/superstructure.html',
    ...
    '    <br><br><b>Recommended amounts.</b> A ship should typically have around ten times its class in superstructure.  Less than this can make it very fragile. Weapons can do in the region of 3d6-6d6 damage (averaging 12-25 damage per shot), so a salvo can easily destroy a ship with too little superstructure.\n' +
    '</p>\n' +
